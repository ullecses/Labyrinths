...
class SolverUtilsTest {
    ...
    public void testGetNeighbors_CornerCell() {
        // Arrange
        Maze maze = new Maze(3, 3);
        maze.getGrid()[0][0] = new Cell(Cell.Type.WALL);
        maze.getGrid()[0][1] = new Cell(Cell.Type.WALL);
        maze.getGrid()[0][2] = new Cell(Cell.Type.WALL);
        ...
        maze.getGrid()[2][0] = new Cell(Cell.Type.WALL);
        maze.getGrid()[2][1] = new Cell(Cell.Type.PASSAGE);
        maze.getGrid()[2][2] = new Cell(Cell.Type.WALL);
    ...
    public void testGetNeighbors_NoNeighbors() {
        ...
        maze.getGrid()[1][0] = new Cell(Cell.Type.WALL);
        maze.getGrid()[1][1] = new Cell(Cell.Type.WALL);
        maze.getGrid()[1][2] = new Cell(Cell.Type.WALL);

        maze.getGrid()[2][0] = new Cell(Cell.Type.WALL);
        maze.getGrid()[2][1] = new Cell(Cell.Type.WALL);
        maze.getGrid()[2][2] = new Cell(Cell.Type.WALL);
